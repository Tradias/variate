...
#ifndef DEHE_TEST_SOURCE_LOCATION_HPP
#define DEHE_TEST_SOURCE_LOCATION_HPP
...
#if _MSC_VER >= 1926
#define TEST_DEHE_CURRENT_LOCATION \
...
#define TEST_DEHE_CURRENT_LOCATION ::test::SourceLocation(::std::source_location::current())
#elif defined(__clang__)
#define TEST_DEHE_CURRENT_LOCATION \
    ::test::SourceLocation(__builtin_FILE(), __builtin_LINE(), __builtin_FUNCTION(), __builtin_COLUMN())
#elif defined(__GNUC__)
#define TEST_DEHE_CURRENT_LOCATION ::test::SourceLocation(__builtin_FILE(), __builtin_LINE(), __builtin_FUNCTION())
#else
#define TEST_DEHE_CURRENT_LOCATION ::test::SourceLocation(__FILE__, __LINE__, "")
#endif

#endif  // DEHE_TEST_SOURCE_LOCATION_HPP
